...
public class DateUtils {
     ...
     * @return 日期，以yyyy-MM-dd  HH:mm:ss.SSS格式输出 1970-03-03  08:00:00.000
     */
    public static String transferToDate(String dateTime,String formatInput) {
        String result = "";
        ...
        try {
            ...
            if(StringUtils.isEmpty(formatInput)){
                SimpleDateFormat defaultFormat = new SimpleDateFormat("yyyyMMdd");
                result = defaultFormat.format(time);
            }else{
                SimpleDateFormat defaultFormat = new SimpleDateFormat(formatInput);
                result = defaultFormat.format(time);
            }
    ...
    public static  String getTimeOf(String s){
